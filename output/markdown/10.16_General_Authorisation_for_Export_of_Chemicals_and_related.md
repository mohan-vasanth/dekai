...
10.16 General Authorisation for Export of Chemicals and related
Equipment (GAEC) of SCOMET items
A., trigger=General Authorisation for Export of Chemicals and related, condition=The Indian Exporter may submit a copy of the Authorised Economic
Operator(AEO) Certification or Status Holder Certificate, if available., validation=Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of
Government of India;
ii., action=The application would be reviewed/examined for the issuance of GAEC by
...
a., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R004, rule_description=The applicant exporter declares that the items that are intended to
be exported shall not be used for any purpose other than the
purpose(s) stated in the EUC and that such use shall not be changed
nor the items modified or replicated without the prior consent of
the Government of India., trigger=General Authorisation for Export of Chemicals and related, condition=Detailed description of the items that are intended to be exported
under this authorisation with relevant technical details /
specifications, such as model, part number, etc., validation=The applicant exporter declares that the items that are intended to
be exported shall not be used for any purpose other than the
purpose(s) stated in the EUC and that such use shall not be changed
nor the items modified or replicated without the prior consent of
the Government of India., action=GAEIS subject to subsequent post reporting(s) on a quarterly basis to be reported
within 30 days from the last quarter;
10.16 General Authorisation for Export of Chemicals and related
Equipment (GAEC) of SCOMET items
A., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R005, rule_description=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
missile system, the exporter would not be eligible for GAEC for
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy., trigger=General Authorisation for Export of Chemicals and related, condition=to be provided (as
...
consignee, end user, etc.) of an intended export is to be provided., validation=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
missile system, the exporter would not be eligible for GAEC for
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy., action=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
...
- rule_id=CH10-SEC10_16-R006, rule_description=After issuance of GAEC authorisation and before actual export, the
applicant exporter must ensure the following:
i., trigger=General Authorisation for Export of Chemicals and related, condition=GAEIS subject to subsequent post reporting(s) on a quarterly basis to be reported
within 30 days from the last quarter;
10.16 General Authorisation for Export of Chemicals and related
Equipment (GAEC) of SCOMET items
A., validation=After issuance of GAEC authorisation and before actual export, the
applicant exporter must ensure the following:
i., action=A declaration is to be submitted by the exporter on Letter Head duly signed and
...
- rule_id=CH10-SEC10_16-R007, rule_description=They shall notify the relevant government authorities in the online
portal of DGFT, within 30 days of such export in the prescribed
format [Aayat Niryat Form ANF 10A along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10J (i) or
(ii), as per applicability] and a copy of the bill of entry into the
...
details
/
specifications, such as model, part number, etc., validation=They shall notify the relevant government authorities in the online
portal of DGFT, within 30 days of such export in the prescribed
format [Aayat Niryat Form ANF 10A along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10J (i) or
(ii), as per applicability] and a copy of the bill of entry into the
destination country within 30 days of delivery at destination point., action=Post reporting for export / re-export of items under GAEC
a., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R008, rule_description=A declaration is to be submitted by the exporter on Letter Head duly signed and
...
required by the DGFT or authorized representatives of
Government of India;
ii., validation=A declaration is to be submitted by the exporter on Letter Head duly signed and
stamped stating that export shall only be done for civilian end use., action=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub-
...
- rule_id=CH10-SEC10_16-R009, rule_description=A declaration from the Indian exporter stating that that the
transfers/exports/re-exports in the entire supply chain would be only for
...
purpose(s) stated in the EUC and that such use shall not be changed
nor the items modified or replicated without the prior consent of
the Government of India., validation=A declaration from the Indian exporter stating that that the
transfers/exports/re-exports in the entire supply chain would be only for
eligible list of countries as provided in Appendix 10(N)., action=GAEC would not be issued in case of items to be used to design, develop,
...
- rule_id=CH10-SEC10_16-R010, rule_description=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub-
...
iii., validation=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub-
categories under GAEC, as mentioned above at II.c., action=GAEC would not be issued for countries or entities covered under UNSC
...
- rule_id=CH10-SEC10_16-R011, rule_description=IMWG shall reserve the right to deny issue of GAEC without assigning
...
missile system, the exporter would not be eligible for GAEC for
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy., validation=IMWG shall reserve the right to deny issue of GAEC without assigning
any reason(s)., action=IMWG shall reserve the right to deny issue of GAEC without assigning
...
- rule_id=CH10-SEC10_16-R012, rule_description=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub- categories
...
applicant exporter must ensure the following:
i., validation=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub- categories
under GAEC, as mentioned above at II.c., action=The Indian exporter shall submit post-shipment details of each export/
re-export of SCOMET items under the above Categories/ sub- categories
...
- rule_id=CH10-SEC10_16-R013, rule_description=IMWG shall reserve the right to deny issue of GAEC without assigning any
...
Certificate (EUC) in the prescribed proforma [Appendix 10J (i) or
(ii), as per applicability] and a copy of the bill of entry into the
destination country within 30 days of delivery at destination point., validation=IMWG shall reserve the right to deny issue of GAEC without assigning any
...
- rule_id=CH10-SEC10_16-R014, rule_description=Suspension / Revocation
GAEC issued shall be liable to be suspended / revoked by the DGFT on receipt of
an adverse report on proliferation concern or for non-submission of mandatory
post-shipment details / reports / documents within the prescribed timelines or for
...
iii., validation=Suspension / Revocation
GAEC issued shall be liable to be suspended / revoked by the DGFT on receipt of
an adverse report on proliferation concern or for non-submission of mandatory
post-shipment details / reports / documents within the prescribed timelines or for
non-compliance with the conditions of the proposed policy., action=GAEC would not be issued in case of items to be used to design, develop,
acquire, manufacture, possess, transport, transfer and / or used for
...
b., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R015, rule_description=Policy & Eligibility: SCOMET authorization will not be required, for export and/or
re-export of Unmanned Aerial Vehicles including drones, remotely piloted air vehicles
and autonomous programmable vehicles specified at 5B(a)(ii), and not covered under
SCOMET Categories/sub-categories 5B(a)(i) & 5B(b), 6A010, 8A912, and capable of
range equal to or less than 25 km and delivering a payload of not more than 25 kgs
...
email id of the authority signing the EUC before actual export., validation=Policy & Eligibility: SCOMET authorization will not be required, for export and/or
re-export of Unmanned Aerial Vehicles including drones, remotely piloted air vehicles
and autonomous programmable vehicles specified at 5B(a)(ii), and not covered under
SCOMET Categories/sub-categories 5B(a)(i) & 5B(b), 6A010, 8A912, and capable of
range equal to or less than 25 km and delivering a payload of not more than 25 kgs
(excluding the software and technology of these items), subject to the following
conditions:
I., action=GAEC would not be issued for countries or entities covered under UNSC
...
c., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R016, rule_description=The applicant exporter shall submit an application for getting a onetime license
under GAED through online SCOMET portal and attach information
in proforma-ANF 10G;
...
civilian end use
v., validation=The applicant exporter shall submit an application for getting a onetime license
under GAED through online SCOMET portal and attach information
in proforma-ANF 10G;
II., action=IMWG shall reserve the right to deny issue of GAEC without assigning any
...
case of any additional sheet used along with the EUC, the same must be on
the letterhead of the company and signed by the same person who signs the
EUC., action=Policy & Eligibility: SCOMET authorization will not be required, for export and/or
re-export of Unmanned Aerial Vehicles including drones, remotely piloted air vehicles
and autonomous programmable vehicles specified at 5B(a)(ii), and not covered under
SCOMET Categories/sub-categories 5B(a)(i) & 5B(b), 6A010, 8A912, and capable of
range equal to or less than 25 km and delivering a payload of not more than 25 kgs
...
- rule_id=CH10-SEC10_16-R019, rule_description=The applicant exporter declares that the items that are intended to be
exported shall not be used for any purpose other than the purpose(s)
stated in the EUC and that such use shall not be changed nor the items
modified or replicated without the prior consent of the Government of
India.;
...
chemical, biological, nuclear weapons or for missiles capable of
delivering weapons of mass destruction and their delivery system;
b., validation=Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of Government of
India;
ii., action=The applicant exporter shall submit an application for getting a onetime license
under GAED through online SCOMET portal and attach information
in proforma-ANF 10G;
...
- rule_id=CH10-SEC10_16-R020, rule_description=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT or if
they know or has reason to believe that an item may be intended for
military end use or has a potential risk of use in or diversion to weapons
of mass destruction (WMD) or in delivery of their missile system, the
...
embargo or sanctions list or on assessment of proliferation concerns,
or national security and foreign policy considerations, etc.;
c., validation=The applicant exporter declares that the items that are intended to be
exported shall not be used for any purpose other than the purpose(s)
stated in the EUC and that such use shall not be changed nor the items
modified or replicated without the prior consent of the Government of
India.;
iii., action=The application would be reviewed/examined for the issuance of GAED by
...
a., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R021, rule_description=After issuance of GAED authorization and before actual export, the applicant
exporter must ensure the following:
i., trigger=General Authorisation for Export of Chemicals and related, condition=(i) and within the timelines
specified therein;
b., validation=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT or if
they know or has reason to believe that an item may be intended for
military end use or has a potential risk of use in or diversion to weapons
of mass destruction (WMD) or in delivery of their missile system, the
exporter would not be eligible for GAED for export of that/those item(s)
and would apply separately to DGFT for a fresh authorization in terms of
regular policy., action=Detailed description of the items that are intended to be exported under this
...
b., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R022, rule_description=They shall notify the relevant government authorities in the online portal
of DGFT, on quarterly basis of such export in the prescribed
format [Aayat Niryat Form (ANF) – 10G], along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10 J (i)] and a
...
pg., validation=Certified / Approved Internal Compliance Programme (ICP) or
...
etc., action=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT or if
they know or has reason to believe that an item may be intended for
military end use or has a potential risk of use in or diversion to weapons
of mass destruction (WMD) or in delivery of their missile system, the
...
- rule_id=CH10-SEC10_16-R023, rule_description=The submitting documents by exporter must include the name, contact
number and email id of the authority signing the EUC before actual
export., trigger=General Authorisation for Export of Chemicals and related, condition=email id of the authority signing the EUC before actual export., validation=After issuance of GAED authorization and before actual export, the applicant
exporter must ensure the following:
i., action=Certified / Approved Internal Compliance Programme (ICP) or
demonstrating compliance to the ICP of the foreign parent company or ICP
certified by the Compliance Manager of the company or certified by any
Government agency such as Authorized Economic Operator (AEO) scheme
...
- rule_id=CH10-SEC10_16-R024, rule_description=The Indian exporter shall submit post-shipment details of each export/ re-
export of SCOMET items under the above Categories/ sub-categories under
...
chemical, biological, nuclear weapons or for missiles capable of delivering
weapons of mass destruction and their delivery system;
b., validation=They shall notify the relevant government authorities in the online portal
of DGFT, on quarterly basis of such export in the prescribed
format [Aayat Niryat Form (ANF) – 10G], along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10 J (i)] and a
copy of the bill of entry into the destination country., action=The submitting documents by exporter must include the name, contact
number and email id of the authority signing the EUC before actual
...
embargo or sanctions list or on assessment of proliferation concerns, or
national security and foreign policy considerations, etc.;
c., validation=The submitting documents by exporter must include the name, contact
number and email id of the authority signing the EUC before actual
export., action=Post reporting for export / re-export of items under GAED
a., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R026, rule_description=Record Keeping
The exporter will be required to keep records of all the export documents, in
manual or electronic form, in terms of Para 10.18 of HBP, for a period of 5 years
...
an adverse report on proliferation concern or for non-submission of mandatory
post-shipment details / reports / documents within the prescribed timelines or for
non-compliance with the conditions of the proposed policy., validation=The Indian exporter shall submit post-shipment details of each export/ re-
export of SCOMET items under the above Categories/ sub-categories under
pg., action=The Indian exporter shall submit post-shipment details of each export/ re-
export of SCOMET items under the above Categories/ sub-categories under
pg., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R027, rule_description=IMWG shall reserve the right to deny issue of GAED without assigning any
...
(excluding the software and technology of these items), subject to the following
conditions:
I., validation=Certified / Approved Internal Compliance
Programme
(ICP)
or
demonstrating compliance to the ICP of the foreign parent company or ICP
certified by the Compliance Manager of the company or certified by any
Government agency such as Authorized Economic Operator (AEO) scheme
etc., action=Certified / Approved Internal Compliance
Programme
(ICP)
or
demonstrating compliance to the ICP of the foreign parent company or ICP
...
Government agency such as Authorized Economic Operator (AEO) scheme
etc., exception=No explicit exception found in uploaded documents., output=DEKAI should produce a compliance decision for 10.16 - General Authorisation for Export of Chemicals and related.
- rule_id=CH10-SEC10_16-R028, rule_description=GAED issued for export / re-export of SCOMET items under the above
Categories / Sub Categories shall be valid for a period of Three years from the
date of issue of GAED subject to subsequent post reporting(s) on quarterly basis
to be reported within 30 days from the last quarter;
...
(Encrypted or Unencrypted, GPRS or satellite based), Accuracy, etc.to be
provided (as applicable);
b., validation=The Indian exporter shall submit post-shipment details of each export/ re-
export of SCOMET items under the above Categories/ sub-categories under
GAED for 3 years, as mentioned above at II.c., action=The Indian exporter shall submit post-shipment details of each export/ re-
export of SCOMET items under the above Categories/ sub-categories under
...
- rule_id=CH10-SEC10_16-R029, rule_description=Suspension / Revocation
GAED issued shall be liable to be suspended / revoked by the DGFT on receipt of an
adverse report on proliferation concern or for non-submission of mandatory post-
shipment details / reports / documents within the prescribed timelines or for non-
...
to be provided by the applicant at the time of submission of application., validation=Record Keeping
The exporter will be required to keep records of all the export documents, in
manual or electronic form, in terms of Para 10.18 of HBP, for a period of 5 years
from the date of GAED issued by DGFT., action=Record Keeping
The exporter will be required to keep records of all the export documents, in
manual or electronic form, in terms of Para 10.18 of HBP, for a period of 5 years
...
Equipment (GAEC) of SCOMET items
A.
- id=10.10.16.7, if=Detailed description of the items that are intended to be exported
under
this
authorisation
with
...
/
specifications, such as model, part number, etc.
- id=10.10.16.8, if=Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of
Government of India;
...
Government of India;
ii.
- id=10.10.16.9, if=The applicant exporter declares that the items that are intended to
be exported shall not be used for any purpose other than the
purpose(s) stated in the EUC and that such use shall not be changed
nor the items modified or replicated without the prior consent of
...
nor the items modified or replicated without the prior consent of
the Government of India.
- id=10.10.16.10, if=Further transfer/export/re-export under
GAEC to the list of applicable countries specified in the Appendix
10(N) will be for civilian end use only;
...
10(N) will be for civilian end use only;
iii.
- id=10.10.16.11, if=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
...
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy.
- id=10.10.16.12, if=After issuance of GAEC authorisation and before actual export, the
applicant exporter must ensure the following:
...
applicant exporter must ensure the following:
i.
- id=10.10.16.13, if=They shall notify the relevant government authorities in the online
portal of DGFT, within 30 days of such export in the prescribed
format [Aayat Niryat Form ANF 10A along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10J (i) or
(ii), as per applicability] and a copy of the bill of entry into the
...
(ii), as per applicability] and a copy of the bill of entry into the
destination country within 30 days of delivery at destination point.
- id=10.10.16.14, if=They have an agreement or a purchase order, excerpt of contract
from entity (consignee / end user) receiving the items which states
that the export is for a permitted use / an end use as declared in
the EUC before actual export;
iii., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
the EUC before actual export;
iii.
- id=10.10.16.15, if=They possess documents include the name, contact number and
...
email id of the authority signing the EUC before actual export.
- id=10.10.16.16, if=Any subsequent transfer/export/re-export under GAEC to the list
of applicable countries specified in the Appendix 10(N) is only for
civilian end use
...
civilian end use
v.
- id=10.10.16.17, if=Additional details, if any sought by DGFT
...
d.
- id=10.10.16.18, if=(i) and within the
timelines specified therein;
...
timelines specified therein;
b.
- id=10.10.16.19, if=GAEC would not be issued in case of items to be used to design, develop,
acquire, manufacture, possess, transport, transfer and / or used for
chemical, biological, nuclear weapons or for missiles capable of
delivering weapons of mass destruction and their delivery system;
b., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
delivering weapons of mass destruction and their delivery system;
b.
- id=10.10.16.20, if=GAEC would not be issued for countries or entities covered under UNSC
embargo or sanctions list or on assessment of proliferation concerns,
or national security and foreign policy considerations, etc.;
...
or national security and foreign policy considerations, etc.;
c.
- id=10.10.16.21, if=(i) and within the timelines
specified therein;
b., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
technology), as well as chemicals listed in the Appendix 10(N), to the
...
specified therein;
b.
- id=10.10.16.22, if=GAEC would not be issued in case of items to be used to design, develop,
...
a., source=GAEC would not be issued in case of items to be used to design, develop,
pg.
- id=10.10.16.23, if=email id of the authority signing the EUC before actual export., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
technology), as well as chemicals listed in the Appendix 10(N), to the
specified countries mentioned in the Appendix 10(N), the applicant
exporter shall submit an application for GAEC through online SCOMET
...
- id=10.10.16.24, if=GAEC would not be issued in case of items to be used to design, develop,
acquire, manufacture, possess, transport, transfer and / or used for
chemical, biological, nuclear weapons or for missiles capable of delivering
weapons of mass destruction and their delivery system;
b., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
weapons of mass destruction and their delivery system;
b.
- id=10.10.16.25, if=GAEC would not be issued for countries or entities covered under UNSC
embargo or sanctions list or on assessment of proliferation concerns, or
national security and foreign policy considerations, etc.;
c., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
...
national security and foreign policy considerations, etc.;
c.
- id=10.10.16.26, if=Suspension / Revocation
GAEC issued shall be liable to be suspended / revoked by the DGFT on receipt of
an adverse report on proliferation concern or for non-submission of mandatory
post-shipment details / reports / documents within the prescribed timelines or for
...
post-shipment details / reports / documents within the prescribed timelines or for
non-compliance with the conditions of the proposed policy.
- id=10.10.16.27, if=Policy & Eligibility: SCOMET authorization will not be required, for export and/or
re-export of Unmanned Aerial Vehicles including drones, remotely piloted air vehicles
and autonomous programmable vehicles specified at 5B(a)(ii), and not covered under
SCOMET Categories/sub-categories 5B(a)(i) & 5B(b), 6A010, 8A912, and capable of
range equal to or less than 25 km and delivering a payload of not more than 25 kgs
...
conditions:
I.
- id=10.10.16.28, if=Detailed description of the items that are intended to be exported under this
authorization with relevant technical details / specifications, including
payloads such as model, part number, other parameters of the drones such
as Payload capacity, Altitude, Range, Endurance, Speed, Communication type
(Encrypted or Unencrypted, GPRS or satellite based), Accuracy, etc.to be
...
provided (as applicable);
b.
- id=10.10.16.29, if=The list of countries where the export is expected to be done under GAED is
...
to be provided by the applicant at the time of submission of application.
- id=10.10.16.30, if=Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of Government of
India;
ii., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
...
India;
ii.
- id=10.10.16.31, if=The applicant exporter declares that the items that are intended to be
exported shall not be used for any purpose other than the purpose(s)
stated in the EUC and that such use shall not be changed nor the items
modified or replicated without the prior consent of the Government of
India.;
...
India.;
iii.
- id=10.10.16.32, if=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT or if
they know or has reason to believe that an item may be intended for
military end use or has a potential risk of use in or diversion to weapons
of mass destruction (WMD) or in delivery of their missile system, the
...
and would apply separately to DGFT for a fresh authorization in terms of
regular policy.
- id=10.10.16.33, if=Certified / Approved Internal Compliance Programme (ICP) or
demonstrating compliance to the ICP of the foreign parent company or ICP
certified by the Compliance Manager of the company or certified by any
Government agency such as Authorized Economic Operator (AEO) scheme
...
Government agency such as Authorized Economic Operator (AEO) scheme
etc.
- id=10.10.16.34, if=After issuance of GAED authorization and before actual export, the applicant
exporter must ensure the following:
i., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
technology), as well as chemicals listed in the Appendix 10(N), to the
...
exporter must ensure the following:
i.
- id=10.10.16.35, if=They shall notify the relevant government authorities in the online portal
of DGFT, on quarterly basis of such export in the prescribed
format [Aayat Niryat Form (ANF) – 10G], along with the End-Use
Certificate (EUC) in the prescribed proforma [Appendix 10 J (i)] and a
...
Certificate (EUC) in the prescribed proforma [Appendix 10 J (i)] and a
copy of the bill of entry into the destination country.
- id=10.10.16.36, if=They have an agreement or a purchase order, excerpt of contract from
entity (consignee / end user) receiving the items which states that the
export is for a permitted use / an end use as declared in the EUC before
actual export;
iii., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
actual export;
iii.
- id=10.10.16.37, if=The submitting documents by exporter must include the name, contact
number and email id of the authority signing the EUC before actual
...
number and email id of the authority signing the EUC before actual
export.
- id=10.10.16.38, if=Additional details, if any sought by DGFT
B., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
technology), as well as chemicals listed in the Appendix 10(N), to the
specified countries mentioned in the Appendix 10(N), the applicant
...
a., source=Additional details, if any sought by DGFT
B.
- id=10.10.16.39, if=Certified / Approved Internal Compliance
Programme
(ICP)
or
demonstrating compliance to the ICP of the foreign parent company or ICP
...
Government agency such as Authorized Economic Operator (AEO) scheme
etc.
- id=10.10.16.40, if=GAED would not be issued in case of items to be used to design, develop, acquire,
manufacture, possess, transport, transfer and / or used for military
applications, explosives, chemical, biological, nuclear weapons or for missiles
capable of delivering weapons of mass destruction and their delivery system;
b., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
capable of delivering weapons of mass destruction and their delivery system;
b.
- id=10.10.16.41, if=GAED would not be issued for countries or entities covered under UNSC
embargo or sanctions list or on assessment of proliferation concerns, or
national security and foreign policy considerations, etc.;
c., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
...
national security and foreign policy considerations, etc.;
c.
- id=10.10.16.42, if=In case of inclusion of new countries or amendment to the existing list of
countries where the export is expected to be done under GAED, the applicant
exporter will obtain prior permission of DGFT with relevant details;
d., then=In respect of export/re-export of SCOMET items under the Categories / Sub
Categories of 1C, 1D,1E, 3D001 and 3D004 (excluding software and
...
exporter will obtain prior permission of DGFT with relevant details;
d.
- id=10.10.16.43, if=GAED issued for export / re-export of SCOMET items under the above
Categories / Sub Categories shall be valid for a period of Three years from the
date of issue of GAED subject to subsequent post reporting(s) on quarterly basis
to be reported within 30 days from the last quarter;
b., then=In respect of export/re-export of SCOMET items under the Categories / Sub
...
to be reported within 30 days from the last quarter;
b.
- id=10.10.16.44, if=Suspension / Revocation
GAED issued shall be liable to be suspended / revoked by the DGFT on receipt of an
adverse report on proliferation concern or for non-submission of mandatory post-
shipment details / reports / documents within the prescribed timelines or for non-
...
where such exports/re-exports are intended under GAEC, for suitable
consideration.
- Run validation: Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of
Government of India;
ii.
...
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy.
- IF detected context matches section rule THEN enforce: After issuance of GAEC authorisation and before actual export, the
applicant exporter must ensure the following:
i.
...
exporter in the prescribed proforma including;
a.
- name=document_4_submitted, type=boolean, required=True, source=Undertaking on the letterhead of the firm duly signed and stamped by
the authorized signatory stating the following:
i.
- name=document_5_submitted, type=boolean, required=True, source=The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
...
export of that/those item(s) and would apply separately to DGFT
for a fresh authorisation in terms of regular policy.
- name=document_6_submitted, type=boolean, required=True, source=Action will be taken against the exporter under FT (D & R) Act,
1992 for any mis-declaration.
...
application and other supporting documents submitted by the applicant
exporter in the prescribed proforma including;
a., Undertaking on the letterhead of the firm duly signed and stamped by
the authorized signatory stating the following:
...
shipment details / reports / documents within the prescribed timelines or for non-
compliance with the conditions of the proposed policy.
- question_en=Which authority handles General Authorisation for Export of Chemicals and related?, answer_en=DGFT, GAEC issued shall be liable to be suspended / revoked by the DGFT, DGFT or authorized representatives of Government, GAED issued by DGFT, GAED issued shall be liable to be suspended / revoked by the DGFT, question_thanglish=Indha General Authorisation for Export of Chemicals and related section-la, Which authority handles General Authorisation for export of Chemicals and related?, answer_thanglish=Indha General Authorisation for Export of Chemicals and related section-la, DGFT, GAEC issued kandippa be liable to be suspended / revoked by the DGFT, DGFT or authorized representatives of Government, GAED issued by DGFT, GAED issued kandippa be liable to be suspended / revoked by the DGFT
...
10(N), the applicant shall provide the list of other destination countries
where such exports/re-exports are intended under GAEC, for suitable
consideration., Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of
Government of India;
...
for a fresh authorisation in terms of regular policy., Action will be taken against the exporter under FT (D & R) Act,
1992 for any mis-declaration..
- Route escalations or approvals to: DGFT, GAEC issued shall be liable to be suspended / revoked by the DGFT, DGFT or authorized representatives of Government, GAED issued by DGFT.
- Show contextual links to related sections: 1, 2, 3, 4, 5, 6, 7, 10.18, 10.20.
...
for a fresh authorisation in terms of regular policy., Action will be taken against the exporter under FT (D & R) Act,
1992 for any mis-declaration..
- Indha General Authorisation for Export of Chemicals and related section-la, Route escalations or approvals to: DGFT, GAEC issued kandippa be liable to be suspended / revoked by the DGFT, DGFT or authorized representatives of Government, GAED issued by DGFT.
- Indha General Authorisation for Export of Chemicals and related section-la, Show contextual links to related sections: 1, 2, 3, 4, 5, 6, 7, 10.18, 10.20.

## AI Metadata
- Keywords: for, and, the, Sub, not, are, may, AEO, etc, end, out, EUC, Any, use, nor, iii, has, WMD, Act, ANF
- Search Keywords: for, and, the, Sub, not, are, may, AEO, etc, end, out, EUC, Any, use, nor, iii, has, WMD, Act, ANF
...
- Related Sections: 1, 2, 3, 4, 5, 6, 7, 10.18, 10.20
- Related Chapters: 
...
10.16 General Authorisation for Export of Chemicals and related
Equipment (GAEC) of SCOMET items
A., The applicant exporter declares that the items that are intended to
be exported shall not be used for any purpose other than the
purpose(s) stated in the EUC and that such use shall not be changed
nor the items modified or replicated without the prior consent of
...
A."]
    S6 --> S7
    S8["The applicant exporter declares that subsequent to issue of export
authorisation, if the licensee has been notified in writing by DGFT
or if they know or has reason to believe that an item may be
intended for military end use or has a potential risk of use in or
diversion to weapons of mass destruction (WMD) or in their
...
for a fresh authorisation in terms of regular policy."]
    S7 --> S8
    S9["A declaration is to be submitted by the exporter on Letter Head duly signed and
stamped stating that export shall only be done for civilian end use."]
    S8 --> S9
...
consideration."]
    S10 --> S11
    S12["Run validation: Any on-site inspection will be allowed by the applicant exporter, if
required by the DGFT or authorized representatives of
Government of India;
ii."]
    S11 --> S12
